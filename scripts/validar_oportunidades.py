...
def main() -> None:
    ...
    checks = [
        ...
        check("source_registry", sources["summary"]["sources"] == 20 and sources["summary"]["indicators"] == 43, "20 fuentes y 43 indicadores validados"),
        ...
        check("ui_contract", all(token in html for token in ('id="oportunidades"', 'id="opp-municipality"', 'id="opp-grid"', 'oferta-gilberto-echeverri.json')), "buscador y fuente publica conectados"),
